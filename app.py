...
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Start coki"
UI_CHAT_DESCRIPTION = os.environ.get("UI_CHAT_DESCRIPTION") or "This coki is configured to answer your questions"
